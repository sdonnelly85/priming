---
title: Analysis of Dative Priming Data at 48 months
...
```{r}
DOD_48mo2 <- filter(DOD_48mo, Prod_DOD > 0)
...
```{r}
m0<- brm(RESPONSE.CODE ~ 1 + (1 | Blind_ID) + (1 | Target.verb),  family="bernoulli", prior=logit_prior, iter=4000, cores=4, data=DOD_48mo, file="48mo/output/m0.rds")
```

```{r}
m0b <- brm(RESPONSE.CODE ~ 1 + (1 | Blind_ID) + (1 | Target.verb) + (1 | Blind_ID:Target.verb),  family="bernoulli", prior=logit_prior, iter=4000, cores=4, data=DOD_48mo, file="48mo/output/m0b.rds")
```
...
```{r}
m1 <- brm(RESPONSE.CODE ~ 1 + Prime.Type*Overlap  +  (1 +  Prime.Type*Overlap | Blind_ID) + (1 +  Prime.Type*Overlap   | Target.verb), logit_prior,family="bernoulli", cores=4, data=DOD_48mo, file="48mo/output/m1.rds")
...
m1d <- DOD_48mo %>%  
  ...
  filter(k < .7) %>%
   brm(RESPONSE.CODE ~ 1 + Prime.Type*Overlap  +  (1 +  Prime.Type*Overlap | Blind_ID) + (1 +  Prime.Type*Overlap   | Target.verb), logit_prior,family="bernoulli", cores=4, data=., file="48mo/output/m1d.rds")
summary(m1d)
...
```{r}
m2 <- brm(RESPONSE.CODE ~ 1 + Prime.Type*Overlap  +  (1 +  Prime.Type*Overlap | Blind_ID) + (1 +  Prime.Type*Overlap   | Target.verb), logit_prior,family="bernoulli", cores=4, data=DOD_48mo2, file="48mo/output/m2.rds")
...
m2d <- DOD_48mo2 %>%  
  ...
  filter(k < .7) %>%
   brm(RESPONSE.CODE ~ 1 + Prime.Type*Overlap  +  (1 +  Prime.Type*Overlap | Blind_ID) + (1 +  Prime.Type*Overlap   | Target.verb), logit_prior,family="bernoulli", cores=4, data=., file="48mo/output/m2d.rds")
summary(m2d)
...
m3 <- brm(RESPONSE.CODE ~ 1 +Prime.Type*biasmatch + (1 + Prime.Type*biasmatch| Blind_ID) + (1 + Prime.Type*biasmatch| Target.verb), logit_prior, family="bernoulli", iter=4000, cores=4, file="48mo/output/m3.rds", data=DOD_48mo3)
summary(m3)
...
m3d<- DOD_48mo3 %>%
  ...
  filter(k < .7) %>%
 brm(RESPONSE.CODE ~ 1 +Prime.Type*biasmatch + (1 +Prime.Type*biasmatch  | Blind_ID) + (1 +Prime.Type*biasmatch | Target.verb), logit_prior, family="bernoulli", iter=4000, cores=4, file="48mo/output/m3d.rds", data=.)
summary(m3d)
...
```{r}
m4 <- brm(RESPONSE.CODE ~ 1 +Prime.Type*biasmatch + (1 + Prime.Type*biasmatch| Blind_ID) + (1 + Prime.Type*biasmatch| Target.verb), logit_prior, family="bernoulli", iter=4000, cores=4, file="48mo/output/m4.rds", data=DOD_48mo4)
summary(m4)
...
m4d<- DOD_48mo4 %>%
  ...
  filter(k < .7) %>%
 brm(RESPONSE.CODE ~ 1 +Prime.Type*biasmatch + (1 +Prime.Type*biasmatch  | Blind_ID) + (1 +Prime.Type*biasmatch | Target.verb), logit_prior, family="bernoulli", iter=4000, cores=4, file="48mo/output/m4d.rds", data=.)
summary(m4d)
...
summary(m4b)
hypothesis(m4b, "Prime.Type > 0")
hypothesis(m4b, "Prime.Type:biasmatchmismatch > 0") # Bias mismatch
```
